...
{
    rooms_.append(new Room(105, 5, {  50, 900,   50, 800, 130, 800, 130, 900}));
    ...
    rooms_.append(new Room(111, 2, { 360, 900,  360, 800, 410, 800, 410, 900}));
    ...
    rooms_.append(new Room(166, 3, { 980, 840,  980, 760, 1060, 760, 1060, 840}, Orientation::UP));
...
void MainWindow::exportCsv()
{
    ...
    if(!f.isOpen()) {
        ...
        foreach(Person* p, people_) {
            stream << p->surname() << CSV_SEPARATOR << p->name() << CSV_SEPARATOR << p->location() << CSV_SEPARATOR << p->department() << CSV_SEPARATOR << p->team() << CSV_SEPARATOR << p->role() << CSV_SEPARATOR << p->component() << CSV_SEPARATOR << p->room() << Qt::endl;
        }
        f.close();
    }
